...
function swing1(self, x, y, z)    --sends 3 values at once on a hit
    --for player 1
    ...
    if( (posX+10)>10 and (posX+10)<25 and math.abs(y)>=0.2 and (playing==1)) then
        PushIt:Push(pitch[1])
        PushVol:Push(1)
...
virtual_space:Handle("OnAccelerate", swing1)
