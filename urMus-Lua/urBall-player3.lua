...
function swing3(self, x, y, z)    --sends 3 values at once on a hit
    --for player 3
    ...
    if( (posX+10)>145 and (posX+10)<170 and math.abs(y)>=0.2 and (playing==1)) then
        PushIt:Push(pitch[3])
        PushVol:Push(1)
...
virtual_space:Handle("OnAccelerate", swing3)
